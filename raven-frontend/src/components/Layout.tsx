...
export const Layout: React.FC<LayoutProps> = ({ children }) => {
  ...
  const cssVars = isDark
    ? {
        ...
        '--avatar-bg':         '#122850',
        '--header-bg':         'rgba(5,16,31,0.92)',
        '--nav-bg':            'rgba(5,16,31,0.96)',
        '--text-primary':      '#f0f5ff',
        '--text-secondary':    'rgba(200,215,240,0.75)',
        '--text-muted':        'rgba(160,185,220,0.5)',
        '--accent-blue':       '#2a6ff5',
    ...
    : {
        ...
        '--inset-bg':          '#eef3fb',
        '--avatar-bg':         '#dce8ff',
        '--header-bg':         'rgba(240,244,250,0.95)',
        '--nav-bg':            'rgba(240,244,250,0.97)',
        '--text-primary':      '#07152b',
        '--text-secondary':    '#2d4a70',
        '--text-muted':        '#7a92b0',
        '--accent-blue':       '#2a6ff5',
        '--accent-blue-light': '#1a5ce0',
        '--accent-cyan':       '#0070cc',
        '--green-active':      '#16a34a',
