...
export class ErrorBoundary extends Component<Props, State> {
  ...
  public componentDidCatch(error: Error, errorInfo: ErrorInfo) {
    console.error('Uncaught error in Raven Admin:', error, errorInfo);
  }
      ...
      return (
        <div className="min-h-screen flex items-center justify-center p-6" style={{ background: '#050608', color: '#fff' }}>
          <div className="max-w-md text-center space-y-4">
            ...
            <h1 className="text-2xl font-bold tracking-tight">Admin Console Error</h1>
            <p className="text-sm text-gray-400">An unexpected error occurred. The issue has been logged for investigation.</p>
            {this.state.error && (
